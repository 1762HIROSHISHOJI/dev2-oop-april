      ...
      <div class="card w-50 mx-auto mt-5 border-0">
          ...
          <div class="card-body">
              <form method="post">
                <div class="form-group">
                    ...
                    <select name="year_level" id="" class="form-control">
                        <option value=""selected disabled hidden>Choose Year Level</option>
                        <option value="first_year">First Year</option>
                        <option value="second_year">Second Year</option>
                        <option value="third_year">Third Year</option>
                        <option value="fourth_year">Fourth Year</option>
                        <!-- option tags can get the value String type as well -->
                    ...
                    <br>
                    <input type="radio" name="status" value="lab"><label>With Laboratory Fee</label>
                    <br>
                    <input type="radio" name="status" value="no_lab"><label>With No Laboratory Fee</label>

                    <br>
                    <br>

                    <button type="submit" name="calculate" class="btn btn-primary form">Calculate</button>
              ...
              if(isset($_POST['calculate'])){
                  ...
                  $school->setValues($yearLevel,$totalUnits,$lab);
