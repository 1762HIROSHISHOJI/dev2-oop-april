    ...
    <div class="row h-100 m-0">
        <div class="card w-25 my-auto mx-auto px-0 border-0">
            ...
            <div class="card-body border-0 bg-light">
                <form action="../views/payment.php?product_id=<?= $product_data['id'] ?>" method="post">
                    <div class="mb-2">
                    ...
                    <div class="row">
                        <div class="col mb-2">
                            ...
                            <p class="h3 text-bold">€<?= $product_data['price'] ?></p>
                        </div>
                        <div class="col mb-2">
                            <label for="stock" class="form-label small fw-bold">Stocks left<span class="form-label small text-danger">*</span></label>
                            <p class="h3 text-bold"><?= $product_data['quantity'] ?></p>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <label for="buy_quantity" class="form-label small fw-bold">Buy Quantity</label>
